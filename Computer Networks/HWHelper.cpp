...
int main(int argc, char const *argv[])
{
    ...
    float matrix[6][6] = {
        {0, 106.087, 6.979, 11.299,  2.801, 24.833},
        {102.056, 0, 71.798,  109.509, 77.138,  62.063},
        {4.554, 73.348,  0, 9.175, 0.809, 25.155},
        {15.893,  117.109, 10.944,  0, 10.517,  25.59},
        {1.804, 78.543,  0.468, 9.678, 0, 38.281},
        {24.61, 63.62, 26.016,  25.358,  38.843,  0}
    };
